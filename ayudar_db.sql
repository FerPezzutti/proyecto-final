...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-12-2017 a las 09:39:16
...
(56, 'Bicicleta MTB', 'Regalo Bicicleta MTB con 21 cambios casi nueva', 'bicicleta.jpg', 7, 1, 2, 2, 9, 0),
(57, 'Cds Rock Nacional', 'Regalo mi coleccion de cds de rock nacional, son mas de 80', 'cds1.jpg', 13, 1, 2, 2, 9, 0),
(58, 'Mecanico', 'Necesito un mecanico para reparar mi auto', 'mecanico.jpg', 14, 1, 1, 1, 9, 1),
(59, 'Pintores', 'Necesito dos pintores para pintar un depto de 2 ambientes', 'pintores.jpg', 11, 1, 1, 1, 9, 1),
(60, 'Vestido de Novia', 'Necesito vestido de novia para casarme, talle xs, preferentemente blanco', 'novia.jpg', 16, 5, 2, 1, 9, 0),
(61, 'Disenador Grafico', 'Necesito un disenador grafico para armar una revista', 'disenador.jpg', 15, 5, 1, 1, 10, 0),
(62, 'Alimentos no perecederos', 'Regalo 100 kilos de alimentos no perecederos', 'alimentos.jpg', 1, 5, 2, 2, 10, 0),
(63, 'Ropa de mujer', 'Regalo prendas varias de mujer, talle XS', 'ropa.jpg', 16, 5, 2, 2, 10, 0);
...
(1, 'Admin', 'istrador', 'admin@admin.com', 'admin', 31933140, 'alegria 1185 dto 9', 'haedo', 1704, 1, 46569921, 1, 65),
...
--
ALTER TABLE `avisos`
  MODIFY `id_aviso` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=79;
--
...
--
ALTER TABLE `avisos_usuarios`
  MODIFY `id_avisosusuarios` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
--
