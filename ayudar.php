			        ...
			        <div class="row">
			        	...
			        	<?php
			                ...
			                if ($provinciafiltro==null && $categoriafiltro==null){
										...
										WHERE a.id_pedidoayuda='1' and NOT a.id_usuario='$userid' and a.estado='0'";
			              ...
			              join avisos_categorias as c on a.id_categoria=c.id_categoria
			              join usuarios as usu on a.id_usuario=usu.id_usuario
			              WHERE a.id_pedidoayuda='1' and NOT a.id_usuario='$userid' and p.id_provincia='$provinciafiltro' and c.id_categoria=$categoriafiltro and a.estado='0'";
			              $result=mysqli_query($link, $query);
			              $numero_resultados = mysqli_num_rows($result);
			            }
